...
There is **no deployment-mode taxonomy in application identity**: an `App` may deploy nothing, one container, or a fleet of Helm charts — its type does not change.
## Design principles
